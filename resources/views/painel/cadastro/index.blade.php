                ...
                <div class="card-content">
                    ...
                    <div class="card-img-overlay overlay-dark d-flex justify-content-between flex-column">
                        ...
                        <div class="overlay-status">
                            <a href="{{asset('/painel/cadastro/cadastro_polo')}}" class="btn btn-primary btn-sm">Clique aqui </a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-img-overlay overlay-dark bg-overlay d-flex justify-content-between flex-column">
                        ...
                        <div class="overlay-status">
                            <a href="{{asset('/painel/cadastro/cadastro_aluno')}}" class="btn btn-primary btn-sm">Clique aqui </a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-content">
                    ...
                    <div class="card-img-overlay overlay-dark d-flex justify-content-between flex-column">
                        ...
                        <div class="overlay-status text-right">
                            <a href="{{asset('/painel/cadastro/cadastro_prazo')}}" class="btn btn-primary btn-sm">Clique aqui </a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-img-overlay overlay-dark d-flex justify-content-between flex-column">
                        ...
                        <div class="overlay-status text-right">
                            <a href="{{asset('/painel/cadastro/cadastro_serie')}}" class="btn btn-primary btn-sm">Clique aqui </a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-content">
                    ...
                    <div class="card-img-overlay overlay-dark d-flex justify-content-between flex-column">
                        <div class="overlay-content">
                            ...
                            <p class="card-text text-ellipsis">
                                Cadastros de Ministérios.
                            </p>
                        </div>
                        <div class="overlay-status">
                            <a href="{{asset('/painel/cadastro/cadastro_ministerio')}}" class="btn btn-primary btn-sm">Clique aqui </a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-img-overlay overlay-dark bg-overlay d-flex justify-content-between flex-column">
                        ...
                        <div class="overlay-status">
                            <a href="{{asset('/painel/cadastro/cadastro_conselho')}}" class="btn btn-primary btn-sm">Clique aqui </a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-img-overlay overlay-dark d-flex justify-content-between flex-column">
                        ...
                        <div class="overlay-status text-right">
                            <a href="{{asset('/painel/cadastro/cadastro_escola')}}" class="btn btn-primary btn-sm">Clique aqui </a>
                        </div>
                    </div>
                </div>
            </div>
